...
class OrderCardManager extends StatefulWidget {
  final UserOrder userOrder;
  const OrderCardManager({super.key, required this.userOrder});
  @override
...
class OrderCardState extends State<OrderCardManager> {
  @override
